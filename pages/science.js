...
// Get your own key!
const apiKey = 'dc9688e65fb0474d8148479a3c330a56';

// Initial News source
const defaultNewsSource = 'new-scientist';

function formatDate(string){
  //string = string.split("T").join(" ").split("Z").join(" ");
    ...
    return (
      <div>
        ...
        <ul className="newsMenu">
          ...
          <li><a href="#" onClick={this.searchNewsAPI} name="everything?q=science">Science News</a></li>
          <li><a href="#" onClick={this.searchNewsAPI} name="top-headlines?country=ie&category=health">Health News Ireland</a></li>
        ...
        <div>
          ...
          {this.state.articles.map((article, index) => (
            <section key={index}>
              ...
              { /* <p><Link as={`/article/${article.source.id}/${index}`} href={`/article?id=${index}&src=${article.source.id}`}><a>Read More</a></Link></p> */}
